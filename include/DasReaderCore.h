...
namespace Libdas {
    ...
    enum DasUniqueValueType {
        ...
        LIBDAS_DAS_UNIQUE_VALUE_TYPE_JOINT_INDEX_BUFFER_ID,
        LIBDAS_DAS_UNIQUE_VALUE_TYPE_JOINT_INDEX_BUFFER_OFFSET,
        LIBDAS_DAS_UNIQUE_VALUE_TYPE_WEIGHT_BUFFER_ID,
        LIBDAS_DAS_UNIQUE_VALUE_TYPE_WEIGHT_BUFFER_OFFSET,
