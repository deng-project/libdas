...
namespace Libdas {
    ...
    struct WavefrontObjVertices {
        std::vector<TRS::Point3D<float>> position;
        std::vector<TRS::Point3D<float>> points;
        std::vector<TRS::Point3D<float>> normals;
        std::vector<TRS::Point2D<float>> texture;
    };
    ...
    struct WavefrontObjIndices {
        ...
        std::vector<TRS::Point2D<int32_t>> lines;
    ...
    namespace WavefrontObjFunctions {
         ...
         * @return TRS::Point2D instance, which contains parsed double indicies
         */
        LIBDAS_API TRS::Point2D<uint32_t> _DoubleIndexBlockCallback(AsciiFormatErrorHandler &_error, const std::string &_block,
         ...
         * @param _line is the current statement line
         * @return TRS::Point3D instance, which contains parsed triple indicies
         */
        LIBDAS_API TRS::Point3D<uint32_t> _TripleIndexBlockCallback(AsciiFormatErrorHandler &_error, const std::string &_block,
                                                                    const std::string &_keyword, const uint32_t _line);
        ...
        //LIBDAS_API void SpecialTRS::PointArgs(WavefrontObjData &_wobj_data, AsciiFormatErrorHandler &_error, ArgsType &_args);
